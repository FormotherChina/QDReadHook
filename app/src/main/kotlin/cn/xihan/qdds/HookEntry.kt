    ...
    override fun onHook() = YukiHookAPI.encase {
        ...
        loadApp(name = QD_PACKAGE_NAME) {
            ...
            if ((optionEntity.viewHideOption.homeOption.configurations.any { it.selected })) {
                homeOption(
                    versionCode,
                    optionEntity.viewHideOption.homeOption.configurations
                )
            }
            ...
            if (versionCode >= 868) {
                newAccountLayout(
                    versionCode,
                    optionEntity.viewHideOption.accountOption.enableNewAccountLayout
                )
            }
            ...
            /*
            findClass("com.qidian.QDReader.core.config.QDConfig").hook {
                injectMember {
                    method {
                        name = "GetSetting"
                        paramCount(2)
                    ...
                    afterHook {
                        ...
                        val s1 = args[1] as? String
                        val s2 = result as? String
                        //"-----start\ns: $s\ns1: $s1\ns2: $s2\n-----end".loge()
//                        // 关键字
//                        val keyWords = listOf("splash")
//                        if (keyWords.any {
//                                s?.contains(it) == true
//                                        || s1?.contains(it) == true
//                                        || s2?.contains(it) == true
...
//                        "-----start\ns: $s\ns1: $s1\ns2: $s2\n-----end".loge()
                        // 关键字
                        val keyWords = listOf("Teenager")
                        if (keyWords.any {
                                s?.contains(it, ignoreCase = true) == true
                                        || s1?.contains(it, ignoreCase = true) == true
                                        || s2?.contains(it, ignoreCase = true) == true
                            }) {
                            "-----start\ns: $s\ns1: $s1\ns2: $s2\n-----end".loge()
                            instance.printCallStack()
                        }
                ...
                injectMember {
                    ...
                    afterHook {
                        ...
                        classLoader?.let {
                             ...
                             */
                            findClass(
                                "com.qq.e.comm.plugin.tangramrewardvideo.c.b",
                                it
                            ).hook {
                                injectMember {
                                    method {
                            ...
                            findClass(
                                "com.qq.e.comm.plugin.tangramrewardvideo.widget.j",
                                it
                            ).hook {
                                injectMember {
                                    method {
                            ...
                            findClass(
                                "com.qq.e.comm.plugin.tangramrewardvideo.c.a",
                                it
                            ).hook {
                                injectMember {
                                    method {
                            ...
                            findClass(
                                "com.qq.e.comm.plugin.tangramrewardvideo.g",
                                it
                            ).hook {
                                injectMember {
                                    method {
