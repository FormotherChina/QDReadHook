...
fun PackageParam.shieldDailyReading(
    ...
    val needHookClass = when (versionCode) {
        ...
        in 860..868 -> "com.qidian.QDReader.component.api.k1"
        else -> null
    }
    ...
    when (versionCode) {
        ...
        in 827..868 -> {
            val needHookClass = when (versionCode) {
                ...
                868 -> "com.qidian.QDReader.ui.adapter.a7"
                else -> null
            }
            needHookClass?.hook {
                injectMember {
...
fun PackageParam.shieldHotAndRecommend(versionCode: Int) {
    val needHookClass = when (versionCode) {
        ...
        868 -> "com.qidian.QDReader.ui.adapter.u"
        else -> null
    }
    needHookClass?.hook {
        injectMember {
    ...
    when (versionCode) {
        ...
        in 804..868 -> {
            val needHookClass = when (versionCode) {
                ...
                868 -> "com.qidian.QDReader.ui.adapter.rb"
                else -> null
            }
            /**
...
fun PackageParam.shieldComicOther(versionCode: Int) {
    val needHookClass = when (versionCode) {
        ...
        868 -> "com.qidian.QDReader.ui.adapter.e2"
        else -> null
    }
    needHookClass?.hook {
        injectMember {
